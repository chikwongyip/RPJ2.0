...
<div class="form-div">
  ...
  <form action="" name="searchForm">
    <img src="/rpj/Public/Admin/images/icon_search.gif" width="26" height="22" border="0" alt="SEARCH" />
...
<table cellpadding="3" cellspacing="1">
  <tr>
    <th>
      ...
      <a href="#">编号</a><img src="/rpj/Public/Admin/images/sort_desc.gif"/>    </th>
  ...
  <tr>
    ...
    <td align="center"><span >100</span></td>
        ...
        <td align="center">
      <a href="#" target="_blank" title="查看"><img src="/rpj/Public/Admin/images/icon_view.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="编辑"><img src="/rpj/Public/Admin/images/icon_edit.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="复制"><img src="/rpj/Public/Admin/images/icon_copy.gif" width="16" height="16" border="0" /></a>
      <a href="<?php echo U('admin/goods/del',array('goods_id'=>$v['goods_id']));?>"  title="回收站"><img src="/rpj/Public/Admin/images/icon_trash.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="货品列表"><img src="/rpj/Public/Admin/images/icon_docs.gif" width="16" height="16" border="0" /></a>          </td>
...
<table id="page-table" cellspacing="0">
  <tr>
    <td align="right" nowrap="true">
        <?php echo ($page); ?>
<!--
          上页&nbsp;&nbsp;1</b>&lt;&lt; [1]&nbsp;&nbsp;<a href=admin.php?c=goods&a=goodsList&page=2& title='第2页'>[2]</a>&nbsp;&nbsp;<a href=admin.php?c=goods&a=goodsList&page=3& title='第3页'>[3]</a>&nbsp;&nbsp;<a href=admin.php?c=goods&a=goodsList&page=4& title='第4页'>[4]