...
<ul>
  <li class="explode" key="02_cat_and_goods" name="menu">
    商品管理        <ul>
          <li class="menu-item"><a href="catelist.html" target="main-frame">商品组管理</a></li>
          <li class="menu-item"><a href="catelist.html" target="main-frame">商品组添加</a></li>
          <li class="menu-item"><a href="catelist.html" target="main-frame">商品分类管理</a></li>
          <li class="menu-item"><a href="catelist.html" target="main-frame">商品分类添加</a></li>
          <li class="menu-item"><a href="goodslist.html" target="main-frame">商品列表</a></li>
          <li class="menu-item"><a href="goodsadd.html" target="main-frame">商品添加</a></li>
        </ul>
      </li>
</ul>
</div>
