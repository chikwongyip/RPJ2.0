...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form enctype="multipart/form-data" action="<?php echo U('admin/product/productedit');?>" method="post" name="theForm" >
        <!-- 最大文件限制 -->
        ...
        <table width="90%" id="general-table" align="center">
          <tr>
            ...
            <td><input type="text" name="productName" value= "<?php echo ($productInfo["productname"]); ?>" style="float:left;color:;" size="30" />  </td>
          </tr>
          <tr>
            <td class="label">
            <a href="#" title="点击此处查看提示信息"><img src="/rpj/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品货号： </td>
            <td><input type="text" name="productSn" value="<?php echo ($productInfo["productsn"]); ?>" size="20"  /><span id="goods_sn_notice"></span><br />
            <span class="notice-span" style="display:block"  id="noticeGoodsSN">如果您不输入商品货号，系统将自动生成一个唯一的货号。</span></td>
          </tr>
          <tr>
            <td class="label">商品分组：</td>
            <td><select name="groupID"  ><option value="<?php echo ($productInfo["groupid"]); ?>">请选择...</option>
          ...
          <tr>
            ...
            <td><select name="parentID"  ><option value="<?php echo ($productInfo["parentid"]); ?>">请选择...</option>
                <option value="6" >手机配件</option>
                <option value="11" >&nbsp;&nbsp;&nbsp;&nbsp;读卡器和内存卡</option>
                <option value="7" >&nbsp;&nbsp;&nbsp;&nbsp;充电器</option>
                <option value="8" >&nbsp;&nbsp;&nbsp;&nbsp;耳机</option>
        ...
        <table width="300%" id="detail-table" style="display:none">
          <tr>
            <td><textarea name="productDesc" > <?php echo ($productInfo["productdesc"]); ?> </textarea></td>
          </tr>
        </table>
